...
class Statistics {
  ...
  private Statistics(double twt, int tnsc, int tnlc) {
    this.totalWaitingTime = twt;
    this.totalNumOfServedCustomers = tnsc;
    this.totalNumOfLostCustomers = tnlc;
  }

  public Statistics copy() {
    return new Statistics(this.totalWaitingTime, this.totalNumOfServedCustomers, this.totalNumOfLostCustomers); 
  }
  ...
  public String toString() {
    return String.format("[%.3f %d %d]",
        this.totalWaitingTime / this.totalNumOfServedCustomers,
